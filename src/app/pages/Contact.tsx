...
const Contact = () => {
  return (
    <div>
        <div className='rounded-t-full bg-blue-600'>
            <h1 className='text-white text-bold text-center text2xl'>Contact</h1>
            <div className='flex justify-around container mx-auto mt-5 pb-5 flex-wrap'>
                ...
                <div className=' flex flex-col gap-5 bg-blue-900 p-8 rounded-md '>
                    ...
                    <Input className='bg-black text-white' type='password' placeholder='Enter your email'/>
