...
import { FaLinux, FaGit, FaAws, FaJenkins, FaTerminal } from "react-icons/fa";
import {
  SiKubernetes,
  SiTensorflow,
  SiTerraform,
...
const experienceData = [
  ...
  {
    id: 3,
    logo: <IoLogoJavascript className="text-[#F7DF1E]" />,
    skill: "JavaScript (ES6+)",
  },
  {
    id: 4,
    logo: <FaBootstrap className="text-[#7952B3]" />,
    skill: "Bootstrap",
  },
  ...
  {
    id: 10,
    logo: <SiTypescript className="text-[#3178C6]" />,
    skill: "TypeScript",
  },
  { id: 11, logo: <FaReact className="text-[#61DAFB]" />, skill: "React" },
  {
    id: 12,
    logo: <SiNextdotjs className="text-[#000000]" />,
    skill: "Next.js",
  },
  ...
  {
    id: 16,
    logo: <SiKubernetes className="text-[#326CE5]" />,
    skill: "Kubernetes",
  },
  ...
  {
    id: 20,
    logo: <FaTerminal className="text-[#4EAA25]" />,
    skill: "Scripting",
  },
  ...
  {
    id: 23,
    logo: <SiTerraform className="text-[#844FBA]" />,
    skill: "Terraform",
  },
  { id: 24, logo: <SiAnsible className="text-[#EE0000]" />, skill: "Ansible" },
  { id: 25, logo: <SiReact className="text-[#61DBFB]" />, skill: "React" },
];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <p className="text-white">
            {" "}
            With a diverse skill set spanning frontend and backend technologies,
            I bring a comprehensive approach to web development. Here&apos;s a
