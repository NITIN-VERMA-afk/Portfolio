...
const Aboutme = () => {
  return (
    <div className="flex mt-32">
      <div>
        <div className="w-64 h-72  border-8 border-blue"></div>
        <div className="relative bottom-80 right-7 ">
          <Image src="/img/profile.jpg" width={250} height={350} alt="My pic" />
        </div>
      </div>
      <div>
        ...
        <Button className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 mt-6">Hire me</Button>
