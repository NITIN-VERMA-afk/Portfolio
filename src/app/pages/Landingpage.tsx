  ...
  const DeveloperSVG = () => (
    ...
    >
      ...
      >
        ...
        <path
          d="M30,10 Q40,10 40,20 Q40,30 30,30"
          stroke="#8b4513"
          strokeWidth="2"
          fill="none"
        />
        ...
        <div className="flex-1 flex flex-col items-center lg:items-start gap-4 sm:gap-6 text-center lg:text-left max-w-full lg:max-w-2xl">
          ...
          >
            ...
            <p className="text-blue-100 text-base sm:text-lg lg:text-xl leading-relaxed max-w-full lg:max-w-xl">
              ...
              experiences that make a difference. Let's bring your ideas to
              life!
            </p>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-2 sm:gap-3">
              {[
                {
                  icon: FaGithub,
                  href: "https://github.com/NITIN-VERMA-afk",
                  label: "GitHub",
                },
                { icon: FaLinkedin, href: "https://www.linkedin.com/in/nitin-verma-7978b51b8", label: "LinkedIn" },
                {
                  icon: Twitter,
                  href: "https://x.com/RAJPUT_NITIN_V",
                  label: "X",
                },
